...
const FlightSearchForm: React.FC<Props> = ({ form, setForm, onSearch, loading }) => {
  ...
  return (
    <div className="bg-white shadow-sm rounded-xl p-6 mb-8 grid grid-cols-1 md:grid-cols-3 gap-4 items-end transition-shadow hover:shadow-md">
      {/* Origin */}
      <div className="flex flex-col">
        <label htmlFor="origin" className="text-gray-700 font-medium mb-1">Origin</label>
        <input
          id="origin"
          name="origin"
          placeholder="JFK"
      ...
      {/* Departure Date */}
      <div className="flex flex-col">
        <label htmlFor="departureDate" className="text-gray-700 font-medium mb-1">Departure</label>
        <input
          id="departureDate"
          name="departureDate"
          type="date"
      ...
      {/* Return Date */}
      <div className="flex flex-col">
        <label htmlFor="returnDate" className="text-gray-700 font-medium mb-1">Return</label>
        <input
          id="returnDate"
          name="returnDate"
          type="date"
      ...
      {/* Adults */}
      <div className="flex flex-col">
        <label htmlFor="adults" className="text-gray-700 font-medium mb-1">Adults</label>
        <input
          id="adults"
          name="adults"
          type="number"
          ...
          value={form.adults}
          onChange={handleChange}
          className="border rounded-lg px-3 py-2 w-20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        />
        {renderError("adults")}
      </div>
      ...
      {/* Max Results */}
      <div className="flex flex-col">
        <label htmlFor="maxResults" className="text-gray-700 font-medium mb-1">Max Results</label>
        <input
          id="maxResults"
          name="maxResults"
          type="number"
      ...
      <div className="md:col-span-3 flex justify-end">
        <button
          ...
          disabled={loading}
          className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition shadow-sm hover:shadow-md"
        >
